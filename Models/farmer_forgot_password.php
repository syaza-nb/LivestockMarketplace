...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "SELECT farmer_id, name FROM farmer WHERE email = :email LIMIT 1";
    ...
    if ($user) {
        ...
        $resetLink = "http://localhost/LivestockMarketplace/Models/farmer_reset_password.php?token=" . $token;
        ...
        try {
            ...
            $mail->Body    = "
                <div style='font-family: Arial, sans-serif; padding: 20px; border: 1px solid #ddd; border-radius: 8px;'>
                    <h2 style='color: #453c34;'>Farmer Portal Password Recovery</h2>
                    <p>Hi " . htmlspecialchars($user['name']) . ",</p>
                    <p>Click the secure link below to reset your farmer account website login credentials:</p>
                    <p><a href='" . $resetLink . "' style='display:inline-block; padding: 10px 20px; background-color: #81c784; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;'>Reset Farmer Password</a></p>
                    <br>
                    <small style='color: #888;'>This secure path configuration link will expire in 30 minutes.</small>
                </div>
            ";
        ...
        header("Location: farmer_forgot_password.php");
        exit();
    } else {
        $_SESSION['status'] = "No farmer account found with that email address.";
        $_SESSION['status_type'] = "error";
        header("Location: farmer_forgot_password.php");
        exit();
    }
...
<head>
<meta charset="UTF-8">
<title>Farmer Forgot Password</title>
...
<div class="login-container">
    ...
    <div class="login-right">
        <a href="farmer_login.php" class="back-btn">
        ...
        <form action="farmer_forgot_password.php" method="POST">
